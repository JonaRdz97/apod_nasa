...
var calendar = document.getElementById('date'); // obtener el elemento input type date
var apod_content = document.getElementsByClassName('content-apod')[0];
var title = document.getElementsByClassName('title')[0];
var date_info = document.getElementsByClassName('date-info')[0];
var explanation = document.getElementsByClassName('explanation')[0];
var button = document.getElementById('btn');
var media; // usada para la imagen/vídeo de la consulta
var fecha_elegida; //usada para que  no se eliga la misma fecha en la consulta
